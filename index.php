...
<head>
	...
	<title>Technology Questions</title>
...
<body class="home">
	...
	<header class="head" role="banner">
		...
		<!--<div class="wrap clearfix">
			<a href="index-2.html" title="SocialChef" class="logo"><img src="images/ico/logo.png" alt="SocialChef logo" /></a>
			
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
					<li class="current-menu-item"><a href="index-2.html" title="Home"><span>Home</span></a></li>
			...
			<nav class="user-nav" role="navigation">
				<ul>
					...
					<li class="dark"><a href="submit_recipe.html" title="Submit a recipe"><i class="ico i-submitrecipe"></i> <span>Submit a recipe</span></a></li>
				</ul>
			</nav>
		</div>
                -->
	...
	<main class="main" role="main">
		<!--intro-->
		<div class="intro">
                    <figure class="bg"><img src="Views/images/intro2.jpg" alt="" /></figure>
			...
			<div class="wrap clearfix">
				...
				<div class="row">
					<article class="three-fourth text wow zoomIn" data-wow-delay=".2s">
						<h1>Bienvenido a Technology Questions!</h1>
						<p>Technology Questions es una <strong>comunidad web</strong> en la que podrás apoyarte para resolver todas las dudas acerca de tecnología que tengas.</p>
						<p>Si no estás registrado en nuestra página, solo podrás ver las intervenciones y preguntas de los usuarios que si lo están, pero no podrás hacer tu aporte, por eso te invitamos a que te registres ahora: </p>
                                                <a href="Views/registro.php" class="button white more medium">UNETE A NUESTRA COMUNIDAD</a>
                                                <p>Ya eres miembro? Click <a href="Views/login.php">AQUÍ</a> para ingresar.</p>
					</article>
		...
		<div class="wrap clearfix">
			...
			<div class="row">
				...
				<section class="content full-width">
					<div class="icons dynamic-numbers">
						<header class="s-title wow fadeInDown">
							<h2 class="ribbon large">Technology Questions en números</h2>
						</header>
						...
						<div class="row wow fadeInUp">
							...
							<div class="one-sixth">
								<div class="container">
									...
									<span class="subtitle">foros</span>
								</div>
							</div>
							<!--//item-->
							...
							<div class="one-sixth">
								<div class="container">
									...
									<span class="subtitle">comentarios</span>
								</div>
							</div>
							<!--//item-->
							...
							<div class="one-sixth">
								<div class="container">
									...
									<span class="subtitle">archivos</span>
								</div>
							</div>
							<!--//item-->
				...
				<section class="content three-fourth">
						...
						<div class="entries row">
							...
							<div class="featured two-third wow fadeInLeft">
								<header class="s-title">
									<h2 class="ribbon">PREGUNTA DEL DÍA</h2>
								</header>
								<article class="entry">
									<figure>
										<img src="images/img2.jpg" alt="" />
										<figcaption><a href="recipe.html"><i class="ico i-view"></i> <span>Ingresar al foro</span></a></figcaption>
									</figure>
									<div class="container">
										...
										<div class="actions">
											<div>
												<!--<a href="#" class="button">Ingresar al foro</a>-->
												<div class="more"><a href="recipes2.html">Ver todas las dudas posteadas en el día</a></div>
											</div>
										</div>
									</div>
								</article>
							...
							<div class="featured one-third wow fadeInLeft" data-wow-delay=".2s">
								<header class="s-title">
									<h2 class="ribbon star">USUARIO DESTACADO</h2>
								</header>
								<article class="entry">
									<figure>
										<img src="images/avatar1.jpg" alt="" />
										<figcaption><a href="my_profile.html"><i class="ico i-view"></i> <span>Ver usuario</span></a></figcaption>
									</figure>
									<div class="container">
										...
										<div class="actions">
											<div>
												<a href="#" class="button">Preguntas asociadas con éste usuario</a>
												<div class="more"><a href="#">Conoce algunos de nuestros usuarios destacados</a></div>
											</div>
										</div>
									</div>
								</article>
					...
					<div class="cwrap">
						<header class="s-title">
							<h2 class="ribbon bright">RECIENTES:</h2>
						</header>
						...
						<div class="entries row">
							...
							<div class="entry one-third wow fadeInLeft">
								<figure>
									...
									<figcaption><a href="recipe.html"><i class="ico i-view"></i> <span>Ver foro</span></a></figcaption>
								</figure>                                                            
								<div class="container">
							...
							<div class="entry one-third wow fadeInLeft" data-wow-delay="1s">
								<figure>
									...
									<figcaption><a href="recipe.html"><i class="ico i-view"></i> <span>Ver archivo</span></a></figcaption>
								</figure>
								<div class="container">
							...
							<div class="quicklinks">
								<a href="#" class="button">MAS FOROS</a>
								<a href="javascript:void(0)" class="button scroll-to-top">Volver al inicio</a>
							</div>
						</div>
						<!--//entries-->
					</div>
					...
					<!--cwrap-->
					<div class="cwrap">
						<h2 class="ribbon bright"> DESTACADOS:</h2>
						<!--entries-->
						<div class="entries row">
							<!--item-->
							<div class="entry one-third wow fadeInLeft">
								<figure>
									...
									<figcaption><a href="blog_single.html"><i class="ico i-view"></i> <span>Ver archivo</span></a></figcaption>
								</figure>
								<div class="container">
							...
							<div class="quicklinks">
								<a href="#" class="button">MAS LINKS</a>
								<a href="javascript:void(0)" class="button scroll-to-top">Volver al inicio</a>
							</div>
						</div>
						<!--//entries-->
	...
	<section class="cta">
		<div class="wrap clearfix">
			<a href="login.html" class="button big white right">UNETE A NOSOTROS</a>
			<h2>Ya estás convencido? </h2>
		</div>
	</section>
	<!--//call to action-->
	...
	<script src="Views/js/jquery.uniform.min.js"></script>
