		...
		<div class="wrap clearfix">
			...
			<!--content-->
				<section class="content center full-width wow fadeInUp">
                                    <form  action="../Controlers/user_controller.php?action=confirmar"  method="POST" > 
					<div class="modal container">
						<h3>RECUPERAR CONTRASEÑA</h3>
						<div class="f-row">
                                                        <input type="text" id="Email" name= "Email" placeholder="Escribe un correo electronico" required="required"/>  
						</div>
						<div class="f-row">
							<input type="password" id="Clave1" name="Clave1" placeholder="Escribe tu nueva contraseña"  required="required" />  
						</div>
						<div class="f-row">
							<input type="password" id="Clave" name="Clave" placeholder="Confirma tu contraseña"  required="required" /> 
						</div>
                                                <br/>
                                                <br/>
						<button id="buttonRegistrar" name="buttonRegistrar" type="submit">ENVIAR</button>
                                     </form>
